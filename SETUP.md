...
generates a real profile, updates `.gitignore`, and installs a thin Contextmink
skill around `tools/contextmink/agent_integration.md` for open Agent
Skills-compatible harnesses and Claude Code. It never edits repository agent
